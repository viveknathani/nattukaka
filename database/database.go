...
import (
	...
	_ "github.com/lib/pq" // going away from the standard here
)
...
// Initialize will open a database connection pool at given dataSourceName.
...
func (db *Database) query(prepared string, scanRows func(rows *sql.Rows) error, args ...interface{}) error {
